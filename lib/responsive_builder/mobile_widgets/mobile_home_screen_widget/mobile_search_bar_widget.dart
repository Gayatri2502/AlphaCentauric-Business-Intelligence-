...
class AndroidSearchWidget extends StatefulWidget {
  @override
  _AndroidSearchWidgetState createState() => _AndroidSearchWidgetState();
}

class _AndroidSearchWidgetState extends State<AndroidSearchWidget> {
